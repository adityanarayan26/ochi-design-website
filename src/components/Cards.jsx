...
const Cards = () => {
    return (
        <div className='w-full h-screen '>
            <div className="card-container  w-full flex py-20 gap-5 px-20">
                <div className="card-box  h-[27vw] rounded-xl w-1/2 bg-[#004D43] flex flex-col justify-center items-center relative">
                    <div className="logo   text-[#CDEA68] scale-[2]">
                    ...
                    <div className="btn rounded-full px-5 py-4 absolute bottom-8 left-10  border-[#CDEA68] border-[1.6px] leading-none text-[#CDEA68] text-[1vw]">
                        <h1 className='font-[Neue_Montreal]'>@2019-2020</h1>
                    </div>


                </div>
                <div className="card-box h-[27vw] rounded-xl w-1/4 bg-[#212121] flex justify-center items-center  relative">
                    <div className="logo   text-[#CDEA68] scale-[2]">

                        <img src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg" alt="" />
                    </div>

                    <div className="btn rounded-full px-5 py-4 absolute bottom-8 left-10  border-zinc-200 border-[1.6px] leading-none text-[#CDEA68] text-[1vw]">
                        <button className='text-zinc-200 font-[Neue_Montreal]'>RATING 0.5 ON CLUTCH</button>
                    </div>
                </div>

                <div className="card-box h-[27vw] rounded-xl w-1/4 bg-[#212121] flex justify-center items-center relative">
                    <div className="logo  text-[#CDEA68] scale-[1vw]">
                        <img src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="" />
                    </div>
                    <div className="btn rounded-full px-5 py-4 absolute bottom-8 left-10  border-zinc-200 border-[1.6px] leading-none text-[#CDEA68] text-[1vw]">
                        <button className='text-zinc-200 font-[Neue_Montreal]'>BUSINESS BOOTCAMP ALLUMNI</button>
                    </div>
                </div>
            </div>
        </div>
